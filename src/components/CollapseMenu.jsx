                      ...
                      <div className="big_period_group">
                        ...
                        <div className="period_group">
                          <button
                            className={
                              selectedOption ===
                              MatchPeriod[indexPeriod].description
                                ? "p_active"
                                : "period"
                            }
                            onClick={() =>
                          ...
                          >
                            {MatchPeriod[indexPeriod].name}
                          </button>
                          <button
                            className={
                              selectedOption ===
                              MatchPeriod[indexPeriod + 1].description
                                ? "p_active"
                                : "period"
                            }
                            onClick={() =>
                          ...
                          >
                            {MatchPeriod[indexPeriod + 1].name}
                          </button>
                          <button
                            className={
                              selectedOption ===
                              MatchPeriod[indexPeriod + 2].description
                                ? "p_active"
                                : "period"
                            }
                            onClick={() =>
                          ...
                          >
                            {MatchPeriod[indexPeriod + 2].name}
                          </button>
                        </div>
                        <button
                          className="change-period-btn"
                ...
                <>
                  <div className="top_menu filter_top">
                    <div className="filter_group">
                      ...
                      <div
                        className={
                          isPopupOpen ? "filter_btn_active" : "filter_btn"
                        }
                        onClick={openPopup}
                      >
                        {selectedFilters.length !== 0 ? (
                          ...
                          >
                            <path
                              fillRule="evenodd"
                              clipRule="evenodd"
                              d="M13.5996 3H4.99986C4.77986 3 4.56986 3.08 4.37986 3.22C3.94986 3.56 3.86986 4.19 4.20986 4.62L9.96986 12H9.99986V17.87C9.95986 18.16 10.0599 18.47 10.2899 18.7L12.2999 20.71C12.6899 21.1 13.3199 21.1 13.7099 20.71C13.9399 20.5 14.0399 20.18 13.9999 19.88V12H14.0299L15.503 10.1126C13.9961 9.13152 12.9999 7.43211 12.9999 5.5C12.9999 4.59978 13.2162 3.75007 13.5996 3ZM16.0504 3C15.4021 3.63526 14.9999 4.52066 14.9999 5.5C14.9999 6.79177 15.6997 7.92009 16.7409 8.52653L19.7899 4.62C20.1299 4.19 20.0499 3.56 19.6199 3.22C19.4299 3.08 19.2199 3 18.9999 3H16.0504Z"
                              fill="#93959A"
                            />
                              ...
                              <div className="box_filter" key={itemIndex}>
                                {item.match(/^\d+$/) ? (
                                  <div
                                    className="signal"
                                    style={{
                                      background: MatchMapping[item].color,
                                    }}
                                  ></div>
                                ) : (
                                  <div
