                            ...
                            <>
                                <button className="close-button" onClick={() => handleClick(item.event_id)}>
                                    {selectedIndex === null ? (<div className="collapse_popup_btn">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 -960 960 960" fill="#93959A" width="16"><path d="M480-345 240-585l43-43 197 198 197-197 43 43-240 239Z" /></svg>
                                    </div>) : (<div className="collapse_popup_btn">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 -960 960 960" fill="#93959A" width="16"><path d="m283-345-43-43 240-240 240 239-43 43-197-197-197 198Z" /></svg>
                                    </div>)}
                                ...
                                <div className="text_group">
                                    ...
                                    {(selectedIndex === item.event_id && item.name !== '') ?
                                        (<div className="container"><p><span className="appellation_element">Имя устройства:&nbsp;</span>
                                    ...
                                    {(selectedIndex === item.event_id && item.target_name !== '') ?
                                        (<div className="container"><p><span className="appellation_element">Имя целевого объекта:&nbsp;</span>
                                    ...
                                    {(selectedIndex === item.event_id && item.alert_template !== '') ? (<div className="container"><p><span className="appellation_element">Шаблон сигнала:&nbsp;</span><span className="item_element">{item.alert_template}</span></p></div>) : (null)}

                                    {(selectedIndex === item.event_id && item.value.emp !== '') ? (<div className="container"><p><span className="appellation_element">Значение:&nbsp;</span><span className="item_element">{item.value} {item.units}</span></p></div>) : (null)}
                                    ...
                                    {(selectedIndex === item.event_id && item.time_value !== '') ?
                                        (<div className="container"><p><span className="appellation_element">Время:&nbsp;</span>
                ...
                <div className="popup chart">
                    <button className="close-button" onClick={handleCloseLinkClick}>
                        <div className="close_popup_btn">
                            <svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 -960 960 960" width="16" fill="#93959A"><path d="m249-207-42-42 231-231-231-231 42-42 231 231 231-231 42 42-231 231 231 231-42 42-231-231-231 231Z" /></svg>
                        </div>
                    </button>
                    <h2>График</h2>
                </div>
